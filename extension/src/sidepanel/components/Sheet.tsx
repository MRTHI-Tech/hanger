...
/**
 * A panel that rises from the foot of the side panel and stops partway up.
 *
 * Detail that belongs to one thing you tapped shouldn't push the rest of a
 * screen around, and it shouldn't sit below the fold — so it comes up over
 * everything instead, right next to the thumb, and leaves when you tap away,
 * press Escape, or pull the grip down.
 */
